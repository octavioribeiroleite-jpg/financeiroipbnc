    ...
    >
      ...
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 flex h-14 items-center justify-between gap-2 border-b border-border bg-card/95 px-3 backdrop-blur sm:h-[68px] sm:px-5 lg:px-6">
          ...
          <div className="border-b border-border bg-card px-3 py-2 xl:hidden">
            <SeletorSociedade
              sociedades={sociedades}
              sociedadeSelecionadaId={sociedadeSelecionadaId}
              setSociedadeSelecionadaId={setSociedadeSelecionadaId}
              simples
              className="h-10 rounded-xl py-0"
            />
          </div>
          ...
          <main className="flex-1 p-3 sm:p-5 lg:p-6 2xl:p-8">
            <div className="mx-auto w-full max-w-[1720px]">
              <div className="mb-4 sm:hidden">
                <h1 className="text-[1.65rem] font-bold leading-tight tracking-[-0.035em] text-foreground">{titulo}</h1>
