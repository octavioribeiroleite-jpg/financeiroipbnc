...
import { useAtualizarSolicitacaoEditavel } from "@/hooks/sociedade/useSolicitacoesSociedadeEditaveis";
...
export function FormSolicitacaoEditavel({ sociedadeId, usuarioId, registro, onConcluido, onCancelar }: Props) {
